...
def text_file(path):
    ...
    np.random.seed(1234)  
    PYTHONHASHSEED = 0
    model_path="C:/Users/sathvik/Desktop/FDIA/login-logout/AuthInMern/server/python/cnn/regression_model_cnn.h5"
...
# text_file("C:/Users/sathvik/Desktop/FDIA/FDIA-PdM-master/Datasets/Attacked test data/Attack scenario/Continuous/Biased.txt")
