...
def test_file(path):
    ...
    model_path = "C:/Users/sathvik/Desktop/FDIA/login-logout/AuthInMern/server/python/lstm/model_lstm.h5";
...
# test_file("C:/Users/sathvik/Desktop/FDIA/login-logout/AuthInMern/server/testDataset/Continuous/Biased.txt")